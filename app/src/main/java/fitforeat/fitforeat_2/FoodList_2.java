...
public class FoodList_2 extends BaseAdapter {
    ...
    public FoodList_2(Context objContext, String[] titleStrings, String[] detailStrings, int[] iconInts) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View objView1 = objLayoutInflater.inflate(R.layout.food_list_2, viewGroup, false);
